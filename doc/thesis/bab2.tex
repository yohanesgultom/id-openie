...
MLP dilatih dengan menggunakan algoritma \textit{backpropagation} dan \textit{gradient descent} \citep{mitchell1997machine}.

\begin{figure}
\centering
\includegraphics[scale=0.5]{../images/mlp.png}
\caption{Visualisasi MLP dengan \textit{input layer} \{$x_1, x_2$\}, dua \textit{hidden layer} \{\{$y_1, y_2, y_3$\}, \{$z_1, z_2$\}\} dan satu \textit{output layer} \{$y$\}}
\label{fig:mlp}
\end{figure}
